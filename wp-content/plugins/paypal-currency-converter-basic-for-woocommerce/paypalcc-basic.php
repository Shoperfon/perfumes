...
class ppcc {
    ...
    protected $data = array(
		...
		'retrieval_count' => 0,
		'autocomplete' => 'off', //PayPal auto completion for virtual products
		'autoprocessing' => 'off', //PayPal auto processing for standard products
		...
		'precision' => '4', //digits to round to
	...
	*/
    ...
    public function options_do_page() {
		...
		if(ppcc_checkit()) {
			echo '<div class="error"><p>Don\'t tamper with the plugin code, and do yourself a favor, and get the PRO version.</p></div>';
		} 
        ...
        echo '<div class="wrap">
            <h2><div class="dashicons dashicons-admin-generic"></div> PayPal Currency Converter BASIC for WooCommerce</h2>
		...
		($options['api_selection']=="api_fixer_io"?$api_fixer_io_checked='checked="checked"': $api_fixer_io_checked='');
		...
		//warning for tampering
		if(ppcc_checkit()) {
			//echo '<div class="error"><p>Don\'t mess with the plugin!!!</p></div>';
			die();
		} 
		...
		echo'   <table class="form-table">
 				<tbody>
					<tr valign="top">
						<th class="titledesc" scope="row" style="width: 250px;">
							<label >'. __('Use custom Currency','PPCC-PRO').': </label>
							<img class="help_tip" data-tip="'. __('Check this to enable your custom currency. Once checked and all custom currency settings are done, save the settings...go to WooCommerce settings and select your custom currency, save it and come back here. ','PPCC-PRO').'" src="'.plugins_url().'/woocommerce/assets/images/help.png" height="16" width="16" />
						</th>
						<td class="forminp"><input type="checkbox" id="ucc" value="1" name="'. $this->option_name.'[ppcc_use_custom_currency]" '.$custom_currency_checkbox_status.' />
							<span id="customcurrency" '.$hidden.'>
								Code:<img class="help_tip" data-tip="'. __('Your custom currency ISO-4217-Code. If the conversion fails...make sure you are using the correct code','PPCC-PRO').'" src="'.plugins_url().'/woocommerce/assets/images/help.png" height="16" width="16" /> <input type="text" size="3" id="ccc" name="'. $this->option_name.'[ppcc_custom_currency_code]" value="'.$options['ppcc_custom_currency_code'].'" '.$required.' disabled/>
								Symbol:<img class="help_tip" data-tip="'. __('Your custom currency symbol.','PPCC-PRO').'" src="'.plugins_url().'/woocommerce/assets/images/help.png" height="16" width="16" /> <input type="text" size="3" id="ccs" name="'. $this->option_name.'[ppcc_custom_currency_symbol]" value="'.$options['ppcc_custom_currency_symbol'].'" '.$required.' disabled/>
								Name:<img class="help_tip" data-tip="'. __('Your custom currency name.','PPCC-PRO').'" src="'.plugins_url().'/woocommerce/assets/images/help.png" height="16" width="16" /> <input type="text" size="8" id="ccn" name="'. $this->option_name.'[ppcc_custom_currency_name]" value="'.$options['ppcc_custom_currency_name'].'" '.$required.' disabled/>
							</span>	
						</td>
                    </tr>
                   <tr valign="top">
						<th class="titledesc" scope="row">
							...
							<img class="help_tip" data-tip="'.__('Source Currency as settled in general settings.','PPCC-PRO').'" src="'.plugins_url().'/woocommerce/assets/images/help.png" height="16" width="16" />
						</th>
					...
					<th class="titledesc" scope="row">
							...
							<img class="help_tip" data-tip="'.__('Desired target currency, what you expect to be billed in PayPal.','PPCC-PRO').'" src="'.plugins_url().'/woocommerce/assets/images/help.png" height="16" width="16" />
						</th>
                    ...
                    <tr valign="top">
						<th class="titledesc" scope="row">
							...
							<img class="help_tip" data-tip="'. __('Accept suggested rate or set your own conversion rate. (Will be overwritten if scheduled update is active.)','PPCC-PRO').'" src="'.plugins_url().'/woocommerce/assets/images/help.png" height="16" width="16" />
						</th>
						<td class="forminp" >
							<input style ="width: 9em;" type="number" placeholder="1" step="'.$pval.'" min="'.$pval.'" max="10000" id="cr" size="'.$options['precision'].'" name="'. $this->option_name.'[conversion_rate]" value="'.$options['conversion_rate'].'" /><img class="help_tip" data-tip="'. __('Input will be red when custom currency is not equal suggested currency. Press the button with the actual rate to accept the current suggested rate.','PPCC-PRO').'" src="'.plugins_url().'/woocommerce/assets/images/help.png" height="16" width="16" />
							'. __('accept','PPCC-PRO').'&#9658;<input type="button" class="button-primary" id="selected_currency" value="'.$exrdata.'"/>
	                ...
	                <tr valign="top">
						<th class="titledesc" scope="row">
							...
							<img class="help_tip" data-tip="'. __('Defines the number of digits to round to.','PPCC-PRO').'" src="'.plugins_url().'/woocommerce/assets/images/help.png" height="16" width="16" />
						</th>
						<td class="forminp">
							<input style ="width: 3em;" type="number" placeholder="1" step="1" min="3" max="8" id="precision_value" name="'. $this->option_name.'[precision]" value="'.$options['precision'].'" disabled/>
							<img class="help_tip" data-tip="'. __('Usually exchange rates are given with 4 digits precision, but depending on your currency pair this can be inaccurate so it can be tweaked to more digits. Min value = 3, max value = 7 digits.','PPCC-PRO').'" src="'.plugins_url().'/woocommerce/assets/images/help.png" height="16" width="16" />
						</td>	
                    </tr>
	                <tr valign="top">
						<th class="titledesc" scope="row">
							<label >'. __('Retrieval Counter','PPCC-PRO').': </label>
							<img class="help_tip" data-tip="'. __('Indicates the number of Currency Exchange Rate retrievals.','PPCC-PRO').'" src="'.plugins_url().'/woocommerce/assets/images/help.png" height="16" width="16" />
						</th>
						<td class="forminp">
				...
				<hr>				
				<h2><div class="dashicons dashicons-list-view"></div>'. __('Currency Exchange Rate Data Provider Selection','PPCC-PRO').'</h2>
				<strong>NO guarantees</strong> are given whatsoever of accuracy, validity, availability, or fitness for any purpose - please use at your own risk.
				<table class="form-table">
				<tbody>
					<tr valign="top">
						<th class="titledesc" scope="row" style="width:250px;">
							<label >'. __('Custom Exchange Rate','PPCC-PRO').' </label>
							<img class="help_tip" data-tip="'. __('Please click this radio button to set your own custom exchange rate .','PPCC-PRO').'" src="'.plugins_url().'/woocommerce/assets/images/help.png" height="16" width="16" />
						</th>
						<td class="forminp">
							<input type="radio" id="custom" name="'. $this->option_name.'[api_selection]" value="custom" '.$custom_checked.'/>
							<img class="help_tip" data-tip="'. __('For those who wish to set there own rate or are not allowed to alter their php.ini settings. .','PPCC-PRO').'" src="'.plugins_url().'/woocommerce/assets/images/help.png" height="16" width="16" />
						</td>
					</tr>
					...
					<tr valign="top">
						<th class="titledesc" scope="row">
							...
							<img class="help_tip" data-tip="'. __('Please click this radio button to choose api.fixer.io as your exchange rate provider.','PPCC-PRO').'" src="'.plugins_url().'/woocommerce/assets/images/help.png" height="16" width="16" />
						</th>
						<td class="forminp">
							<input type="radio" id="api_fixer_io" name="'. $this->option_name.'[api_selection]" value="api_fixer_io" '.$api_fixer_io_checked.'/>Source <a href="http://api.fixer.io">api.fixer.io</a>					
						</td>
					</tr>
					...
					<tr valign="top">
						<th class="titledesc" scope="row">
							...
							<img class="help_tip" data-tip="'. __('Please click this radio button to choose free.currencyconverterapi.com as your exchange rate provider. It is free but max precission is 6 digits.','PPCC-PRO').'" src="'.plugins_url().'/woocommerce/assets/images/help.png" height="16" width="16" />
						</th>
						<td class="forminp">
					...
					<tr valign="top" '.$hide_bnro.'>
						<th class="titledesc" scope="row">
							...
							<img class="help_tip" data-tip="'. __('Please click this radio button to choose BNRO ( Banca Naţională a României) as your exchange rate provider.','PPCC-PRO').'" src="'.plugins_url().'/woocommerce/assets/images/help.png" height="16" width="16" />
						</th>
						<td class="forminp">
							<input type="radio" id="bnro" name="'. $this->option_name.'[api_selection]" value="bnro" '.$bnro_checked.'/><img class="help_tip" data-tip="'. __('BANK of Romania<br>(Base = RON)','PPCC-PRO').'" src="'.plugins_url().'/woocommerce/assets/images/help.png" height="16" width="16" /> Source <a href="http://www.bnro.ro/nbrfxrates.xml">BNRO</a>						
						</td>
                    </tr>
					...
					<tr valign="top">
						<th class="titledesc" scope="row">
							...
							<img class="help_tip" data-tip="'. __('Please click this radio button to choose OPENEXCHANGERATES as your exchange rate provider.','PPCC-PRO').'" src="'.plugins_url().'/woocommerce/assets/images/help.png" height="16" width="16" />
						</th>
						<td class="forminp">
							<input type="radio" id="oer_api" name="'. $this->option_name.'[api_selection]" value="oer_api_id" '.$oer_api_checked.'  disabled/> 
							<input type="text" size="35" id="oer_api_id" name="'. $this->option_name.'[oer_api_id]" value="'.$options['oer_api_id'].'"  disabled/>
							<img class="help_tip" data-tip="'. __('Register your Open Exchange Rate API ID in this text field and save.<br/>(Base = USD)','PPCC-PRO').'" src="'.plugins_url().'/woocommerce/assets/images/help.png" height="16" width="16" /> Get the API ID here: <a href="https://openexchangerates.org">openexchangerates.org</a>
						</td>
                    </tr>
					...
					<tr valign="top">
						<th class="titledesc" scope="row" >
							...
							<img class="help_tip" data-tip="'. __('Please click this radio button to choose XIGNITE as your exchange rate provider.','PPCC-PRO').'" src="'.plugins_url().'/woocommerce/assets/images/help.png" height="16" width="16" />
						</th>
						<td class="forminp">
							<input type="radio" id="xignite_api" name="'. $this->option_name.'[api_selection]" value="xignite" '.$xignite_checked.'  disabled/> 
							<input type="text" size="35" id="oer_api_id" name="'. $this->option_name.'[xignite_api_id]" value="'.$options['xignite_api_id'].'"  disabled/>
							<img class="help_tip" data-tip="'. __('Register your XIGNITE API ID in this text field and save.<br/>(Base = USD)','PPCC-PRO').'" src="'.plugins_url().'/woocommerce/assets/images/help.png" height="16" width="16" /> Get the API ID here: <a href="https://www.xignite.com">xignite.com</a>
						</td>
                    </tr>
					...
					<tr valign="top">
						<th class="titledesc" scope="row" >
							...
							<img class="help_tip" data-tip="'. __('Please click this radio button to choose APILAYER as your exchange rate provider.','PPCC-PRO').'" src="'.plugins_url().'/woocommerce/assets/images/help.png" height="16" width="16" />
						</th>
						<td class="forminp">
							<input type="radio" id="apilayer_api" name="'. $this->option_name.'[api_selection]" value="apilayer" '.$apilayer_checked.' disabled/> 
							<input type="text" size="35" id="oer_api_id" name="'. $this->option_name.'[apilayer_api_id]" value="'.$options['apilayer_api_id'].'" disabled/>
							<img class="help_tip" data-tip="'. __('Register your APILAYER API ID in this text field and save.<br/>(Base = USD)','PPCC-PRO').'" src="'.plugins_url().'/woocommerce/assets/images/help.png" height="16" width="16" /> Get the API ID here: <a href="https://currencylayer.com/product">currencylayer.comt</a>
						</td>
                    </tr>
				...
				<hr>
				<h2><div class="dashicons dashicons-plus-alt"></div>'. __('Handling fees','PPCC-PRO').'
				<img class="help_tip" data-tip="'. __('If you want to add handling fees on the transaction. (You may not name it surcharge! Check PayPal User Agreement.)','PPCC-PRO').'" src="'.plugins_url().'/woocommerce/assets/images/help.png" height="16" width="16" />
				</h2>
				<table class="form-table">
				<tbody>
					<tr valign="top">
						<th class="titledesc" scope="row" style="width: 250px;">
							...
							<img class="help_tip" data-tip="'. __('Enter a percentage value other then 0 to add a percentage on the total order amount(befor fixed amount is added).','PPCC-PRO').'" src="'.plugins_url().'/woocommerce/assets/images/help.png" height="16" width="16" />
						</th>
						<td class="forminp">
							<input style ="width: 5em;" type="number" placeholder="1.0" step="0.01" min="0" max="10" id="handling_percentage"  name="'. $this->option_name.'[handling_percentage]" value="'.$options['handling_percentage'].'"  disabled/> in %
							<img class="help_tip" data-tip="'. __('A handling fee percentage should be in a reasonable range, certainly and most probably lower then 5%. Min value = 0.00%(equals no percentual handling fee), max value = 10.00%.'		,'PPCC-PRO').'" src="'.plugins_url().'/woocommerce/assets/images/help.png" height="16" width="16" /> 
						</td>
                    </tr>
                    <tr valign="top">
						<th class="titledesc" scope="row" style="width: 250px;">
							<label >'. __('Fixed amount','PPCC-PRO').' </label>
							<img class="help_tip" data-tip="'. __('Enter a handling fee amount value other then 0 to add a fixed amount to the order total as handling fee.','PPCC-PRO').'" src="'.plugins_url().'/woocommerce/assets/images/help.png" height="16" width="16" />
						</th>
						<td class="forminp">
							<input style ="width: 5em;" type="number" placeholder="1.0" step="0.01" min="0" max="10000" id="handling_amount"  name="'. $this->option_name.'[handling_amount]" value="'.$options['handling_amount'].'"  disabled/> in '.get_woocommerce_currency().'
							<img class="help_tip" data-tip="'. __('A handling fee amount should be in a reasonable range given in the shop currency. Min value = 0.00(equals no fixed handling fee amount), max value = 10\'000.00 units in shop currency.','PPCC-PRO').'" src="'.plugins_url().'/woocommerce/assets/images/help.png" height="16" width="16" />
						</td>
                    </tr>
                    <tr valign="top">
						<th class="titledesc" scope="row" style="width: 250px;">
							<label >'. __('Taxable','PPCC-PRO').' </label>
							<img class="help_tip" data-tip="'. __('Check this to enable standard tax calculation on handling fee. Please consider not to tax customers abroad.','PPCC-PRO').'" src="'.plugins_url().'/woocommerce/assets/images/help.png" height="16" width="16" />
						</th>
						<td class="forminp"><input type="checkbox" id="htax" value="1" name="'. $this->option_name.'[handling_taxable]" '.$handling_taxable_checkbox_status.'  disabled/> Handling fee will be taxed when checked.
						</td>
                    </tr> 
                    <tr valign="top">
						<th class="titledesc" scope="row" style="width: 250px;">
							<label >'. __('Shipping included','PPCC-PRO').' </label>
							<img class="help_tip" data-tip="'. __('Check this to also calculate the percentage handling fee including shipping cost.','PPCC-PRO').'" src="'.plugins_url().'/woocommerce/assets/images/help.png" height="16" width="16" />
						</th>
						<td class="forminp"><input type="checkbox" id="htax" value="1" name="'. $this->option_name.'[shipping_handling_fee]" '.$shipping_handling_fee_checkbox_status.'  disabled/> Handling fee percentage will also take shipping cost into account.
						</td>
                    </tr>                  
                    <tr valign="top">
						<th class="titledesc" scope="row" style="width: 250px;">
							<label >'. __('Custom title','PPCC-PRO').' </label>
							<img class="help_tip" data-tip="'. __("Name your handling fee. 'Handling fee' recommended.",'PPCC-PRO').'" src="'.plugins_url().'/woocommerce/assets/images/help.png" height="16" width="16" />
						</th>
						<td class="forminp"><input type="text" id="htitle" value="'. $options['handling_title'].'" name="'. $this->option_name.'[handling_title]"  disabled/> Custom handling fee title.
						</td>
                    </tr>  
   				</tbody>
				</table>
				<hr>
				<h2><div class="dashicons dashicons-info"></div>'. __('Order Status Handling','PPCC-PRO').'
				<img class="help_tip" data-tip="'. __('Normal behavior of PayPal is to set Orders on_hold due to the difference in amount and currency.','PPCC-PRO').'" src="'.plugins_url().'/woocommerce/assets/images/help.png" height="16" width="16" />
				</h2>
				<table class="form-table">
				<tbody>
					<tr valign="top">
						<th class="titledesc" scope="row" style="width: 250px;">
							...
							<img class="help_tip" data-tip="'. __('Check this to override PayPal\'s amount and currency comparison-check on your own risk.','PPCC-PRO').'" src="'.plugins_url().'/woocommerce/assets/images/help.png" height="16" width="16" />
						</th>
						<td class="forminp"><input type="checkbox" id="ac" value="1" name="'. $this->option_name.'[autocomplete]" '.$autocomplete_checkbox_status.'  disabled/> Orders for virtual (downloadable) products will be completed when checked and stock will be reduced.
						</td>
                    </tr>
                    <tr valign="top">
						<th class="titledesc" scope="row" style="width: 250px;">
						...
						<td class="forminp"><input type="checkbox" id="ap" value="1" name="'. $this->option_name.'[autoprocessing]" '.$autoprocessing_checkbox_status.'  disabled/> Orders for standard products will be set to processing and stock will be reduced when checked.
						</td>
                    </tr>
				</tbody>
				</table>
				<hr>
				<h2><div class="dashicons dashicons-email"></div>'. __('Email Order Complete Note','PPCC-PRO').'
				<img class="help_tip" data-tip="'. __('Add Information to the Order Completete Email.','PPCC-PRO').'" src="'.plugins_url().'/woocommerce/assets/images/help.png" height="16" width="16" />
				</h2>
				<table class="form-table">
				<tbody>
					<tr valign="top">
						<th class="titledesc" scope="row" style="width: 250px;">
							...
							<img class="help_tip" data-tip="'. __('checked = add the note / unchecked = no action','PPCC-PRO').'" src="'.plugins_url().'/woocommerce/assets/images/help.png" height="16" width="16" />
						</th>
						<td class="forminp"><input type="checkbox" id="ac" value="1" name="'. $this->option_name.'[email_order_completed_note]" '.$email_order_completed_note_checkbox_status.'  disabled/> Adds a note to the order receipt email about the conversion and converted total amount paid via PayPal.
						</td>
                    </tr>
                    <tr>
                    <th>
                    	Email order note html:
						<img class="help_tip" data-tip="'. __('Here you may edit the text that will be displayed in the Email order notification.<br>The sequence for placeholder %s and their content is fixed. <ol><li>%s = exchangerate</li><li>%s = shop currency</li><li>%s = target currency</li><li>%s = converted order total</li><li>%s = handling percentage</li><li>%s = handling amount in '.$options['target_currency'].'</li></ol>','PPCC-PRO').'" src="'.plugins_url().'/woocommerce/assets/images/help.png" height="16" width="16" />
                    </th>
                    <td>
                    	<textarea cols="80" rows="3" id="order_email_note" name="'. $this->option_name.'[order_email_note]"  disabled/>'.$options['order_email_note'].'</textarea>
                    </td>
                    </tr>
					<tr valign="top">
                    <th>
                    	Email order note rendered:
						<img class="help_tip" data-tip="'. __('This is what will be displayed in the Email order notification, except the Order Total will be calculated accordingly.<br> Save your settings to see the current result.','PPCC-PRO').'" src="'.plugins_url().'/woocommerce/assets/images/help.png" height="16" width="16" />
                    </th>
                    <td><em>'.
				...
				<hr>					
				<h2><div class="dashicons dashicons-calendar"></div>'. __('Scheduled Currency Exchange Rate Update','PPCC-PRO').'</h2>
				<table class="form-table">
				<tbody>
                    <tr valign="top">
						<th class="titledesc" scope="row" style="width: 250px;">
							<label >'. __('Activate Scheduled Update','PPCC-PRO').' </label>
							<img class="help_tip" data-tip="'. __('Check this to have the exchange rate automatically updated dependant on your settings in your hosting server\'s Cron Job or in your Wordpress\'s Cron Job plugin.','PPCC-PRO').'" src="'.plugins_url().'/woocommerce/assets/images/help.png" height="16" width="16" />
						</th>
						<td class="forminp"><input type="checkbox" id="ud" value="1" name="'. $this->option_name.'[auto_update]" '.$auto_update_checkbox_status.'  disabled/> Make sure to have a valid API ID registered above when using Open Exchange Rates API! 
						</td>
                    </tr>
	               <tr valign="top">
						<th class="titledesc" scope="row">
							<label >'. __('Last Update','PPCC-PRO').' </label>
							<img class="help_tip" data-tip="'. __('Indicates the last time the Currency Exchange Rate was updated manually or automatic.','PPCC-PRO').'" src="'.plugins_url().'/woocommerce/assets/images/help.png" height="16" width="16" />
						</th>
						<td class="forminp">
					...
					<tr valign="top">
						<th class="titledesc" scope="row">
							...
							<img class="help_tip" data-tip="'. __('Check this to write actions into log file.','PPCC-PRO').'" src="'.plugins_url().'/woocommerce/assets/images/help.png" height="16" width="16" />
						</th>
						<td class="forminp"><input type="checkbox" id="ud" value="1" name="'. $this->option_name.'[exrlog]" '.$exrlog_checkbox_status.' disabled/> Notification email for each Exchange Rate Update will be sent to '.get_ppcc_option('admin_email').'
						</td>
                    </tr>					
					<tr valign="top">
						<th scope="row" class="titledesc"><label >'.__('Scheduler log','PPCC-PRO').' </label><img class="help_tip" data-tip="'.__('Log location of Currerncy Exchange Rate updates.','PPCC-PRO').'" src="'. plugins_url().'/woocommerce/assets/images/help.png" height="16" width="16" /></th>
						<td class="forminp">	
							'. sprintf( __( '<code>../wp-content/uploads/wc-logs/PPCC-%s.txt</a></code><br/>', 'PPCC-PRO' ), sanitize_file_name( wp_hash( 'ppcc' ) ) ) . '
						</td>
					</tr>			
					<tr valign="top">
						<th scope="row" class="titledesc"><label >'.__('Ajax Call URL for Cron Job','PPCC-PRO').' </label><img class="help_tip" data-tip="'.__('Call this URL from your Hosting Servers Cron Job for exactly timed currency updates.','PPCC-PRO').'" src="'. plugins_url().'/woocommerce/assets/images/help.png" height="16" width="16" /></th>
						<td class="forminp">	
					...
					<tr valign="top">
						<th scope="row" class="titledesc">
							<label >'.__('Hook to call for "WP Cron" Job','PPCC-PRO').' </label>
								<img class="help_tip" data-tip="'.__('Call the Hook \'ppcc_cexr_update\' from your Cron Job Plugin. But consider that Wordpress\'s Cron System is dependant on traffic and not necessarily timely exact.','PPCC-PRO').'" src="'. plugins_url().'/woocommerce/assets/images/help.png" height="16" width="16" />
						</th>
						<td class="forminp">
				...
				<tbody>
					<tr valign="middle">
						...
						<td class="forminp">
							<a href="https://codecanyon.net/user/intelligent-it">
								<img class="help_tip" data-tip="'. __('PayPal Currency Converter PRO Plugin was brought to you by intelligent-it.','PPCC-PRO').'" src="'.plugins_url('/assets/images/intelligent-it-logo.png',__file__).'" />
							</a> 
						</td>
					</tr>
					<tr valign="middle">
						...
						<td class="forminp">
							 on YouTube <a href="https://www.youtube.com/watch?v=B-rlzUBJ8B8">PayPal Currency Converter Pro for WooCommerce Demo</a>	
						</td>
						<td class="forminp">
						</td>
					</tr>
					<tr valign="middle">
						...
						<td class="forminp">
						Paypal Currency Converter Pro is also capable of working with <a href="http://www.woothemes.com/products/paypal-digital-goods-gateway/" title="PayPal Digital Goods">PayPal Digital Goods gateway</a> and <a href="http://docs.woothemes.com/document/paypal-payments-advanced/" titel="PayPal Advanced">PayPal Advanced</a> besides PayPal Standard .<br/>
						However this needs some tiny customization in the plugins.<br/>
						Mainly it is the shop currency to be set in the allowed currencies.<br/>
						</td>
						<td class="forminp">
					...
					<tr valign="middle">
						...
						<td class="forminp">
						Use this plugin at your own risk, <strong>test in advance in "sandbox" mode</strong>. Intelligent-IT shall not be liable for any loss or injury caused in whole, or in part, by its actions, omissions, or contingencies beyond its control, including in procuring, compiling, or delivering the information, or arising out of any errors, omissions, or inaccuracies in the information regardless of how caused, or arising out of any user\'s decision, or action taken or not taken in reliance upon information furnished.</br>
						</td>
						<td class="forminp">
						</td>
				...
				<hr>					
				<h2><div class="dashicons dashicons-testimonial"></div>'. __('System Info','PPCC-PRO').'</h2>
					<table class="form-table">
					<tbody>		
					<tr valign="top">
						<th scope="row" class="titledesc"><label >'.__('System versions','ppcc').' </label><img class="help_tip" data-tip="'.__('information about your systems versions','ppcc').'" src="'. plugins_url().'/woocommerce/assets/images/help.png" height="16" width="16" /></th>
						<td class="forminp">'
						. $currentsystem.
						'</td>
					</tr>
					<tr valign="top">
						<th scope="row" class="titledesc"><label >'.__('Multisite setup','ppcc').' </label><img class="help_tip" data-tip="'.__('information about your setup','ppcc').'" src="'. plugins_url().'/woocommerce/assets/images/help.png" height="16" width="16" /></th>
						<td class="forminp">'
						. $multisitesetup.
						'</td>
					</tr>	
